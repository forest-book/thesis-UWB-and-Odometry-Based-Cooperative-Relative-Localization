...
if __name__ == '__main__':
    ...
    if not FileSystem_Adapter.file_exists(path=config_path):
    ...
    config_filename = FileSystem_Adapter.get_filename(file_path=config_path)
    # 現在の日時を取得
    ...
    # --- 使用した設定ファイルのコピー ---
    FileSystem_Adapter.file_copy(source_path=config_path, destination_path=save_dir)
