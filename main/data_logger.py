...
class DataLogger:
    ...
    def __init__(self, save_dir: str):
        ...
        FileSystem_Adapter.create_directory(path=self.save_dir, exist_ok=True)
    ...
    def save_fused_RL_error_statistics(self, transient_time: float = 10.0,
        ...
        FileSystem_Adapter.create_directory(path=stats_dir, exist_ok=True)
    ...
    def save_UAV_trajectories_data_to_csv(self, filename: Optional[str] = None):
        ...
        FileSystem_Adapter.create_directory(path=csv_dir, exist_ok=True)
